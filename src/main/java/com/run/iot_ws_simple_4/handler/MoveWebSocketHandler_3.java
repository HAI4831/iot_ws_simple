...
//            } else if (message.contains("temperature_data")) {
//                key = "temperature_data";
//                value = extractValueFromJson(message, "temperature_data");
//            } else if (message.contains("humidity_data")) {
//                key = "humidity_data";
//                value = extractValueFromJson(message, "humidity_data");
//            }
//
...
////                sendJsonResponse(session, key, value);
//            }
